	...
	<section>
		<div class="container">
			<div class="row">
				...
				<!-- 	<img src="view?fileLoca=20201212&fileName=icon.png">					
					 -->
		...
		<script>
			...
			$(document).ready(function(){
				...
				function regist(){
					...
					//ajax폼 전송의 핵심 FormData 객체 생성
					
					var fileData =$('#file');
					var formData =new FormData(); //ajax 폼전송의 핵심 FormData 핵심객체
				/* 		
				...
				var content = $("#content").val();//textarea 의 값
				...
				function getList (reset){
					...
					//2.contentDiv 영역안에 list 개수 만큼 회전해서 화면을 추가
